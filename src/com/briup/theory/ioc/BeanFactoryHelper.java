...
public class BeanFactoryHelper {
	...
	parseXML(String path)throws Exception {
		Map<String, Object> map = 
			new HashMap<String, Object>();
		Map<String,TempValue> temp = 
			new HashMap<String,TempValue>();
		...
		for(Element e1:elements1){
			...
			String beanName = e1.attributeValue
					("name");
			String className = 
					e1.attributeValue("class");
